  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-pastel-mint p-6 flex items-center justify-center">
        <div className="text-pastel-primary">Cargando imágenes del carrusel...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-pastel-mint p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-pastel-primary">Gestión del Carrusel</h1>
        ...
        <div className="card-pastel p-6 rounded-lg mb-8">
          ...
          <div className="space-y-4">
            ...
            {preview.length > 0 && (
              <div>
                <h3 className="text-lg font-medium mb-3 text-pastel-secondary">Vista previa:</h3>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4">
                  {preview.map((item, index) => (
                    <div key={index} className="card-pastel p-2 rounded">
                      ...
                      />
                      <p className="text-xs text-pastel-muted mt-1 truncate">{item.name}</p>
                    </div>
                  ))}
                </div>
        ...
        <div className="card-pastel p-6 rounded-lg">
          ...
          {images.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-xl text-pastel-secondary">No hay imágenes en el carrusel</p>
              <p className="text-pastel-muted">Sube algunas imágenes para comenzar</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {images.map((image) => (
                <div key={image._id} className="card-pastel rounded-lg overflow-hidden">
                  ...
                  <div className="p-4">
                    <p className="text-pastel-primary font-medium truncate">{image.originalName}</p>
        ...
        <div className="mt-8 bg-pastel-blue border border-pastel-blue-dark rounded-lg p-6">
          <h3 className="text-lg font-semibold text-pastel-primary mb-3">💡 Recomendaciones</h3>
